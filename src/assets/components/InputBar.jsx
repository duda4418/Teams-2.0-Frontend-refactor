...
const OPEN_AI_ID = import.meta.env.VITE_OPEN_AI_ID;
...
export default function InputBar({discussion, user}) {
    ...
    const sendMessage = async () => {
        ...
        try {
            const isOpenAI = discussion.contacts.includes(OPEN_AI_ID); 
            const endpoint = isOpenAI ? "openai" : "messages";
